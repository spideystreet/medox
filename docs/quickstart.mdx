...
```bash
git clone https://github.com/spideystreet/medox.git
cd medox
...
DAGSTER_HOME="/chemin/absolu/vers/medox/.dagster"

# SSL — certificats CA pour les sites du gouvernement français
SSL_CERT_FILE="/chemin/absolu/vers/medox/certs/ca-bundle.pem"
```
