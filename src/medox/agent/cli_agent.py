"""
CLI entry point for interacting with the Medox agent.
Streams LangGraph events to stdout for local observability.

Usage:
    uv run python -m medox.agent.cli_agent "Quelles interactions avec l'amiodarone ?"
"""
...
from medox.agent.graph_agent import get_graph
