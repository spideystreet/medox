...
export function LandingPage({ onEnter }: LandingPageProps) {
  ...
  return (
    <div className="h-screen bg-surface flex flex-col overflow-hidden relative">
      ...
      {/* Top bar — version & GitHub (right) */}
      <div
        className={`relative z-10 pt-4 px-6 flex justify-end items-center gap-3 transition-opacity duration-700 ${showContent ? "opacity-100" : "opacity-0"}`}
      >
        {version && (
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          ...
          <div className={`transition-all duration-700 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            ...
            <div className="flex items-center justify-center gap-1.5 mt-6 text-text-muted text-[10px] uppercase tracking-wider">
              Works better with
